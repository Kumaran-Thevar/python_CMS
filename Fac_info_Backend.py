...
def connect():
       ...
       cur.execute("CREATE TABLE IF NOT EXISTS faculty (id INTEGER PRIMARY KEY, name text, email text, address text, mobno integer,edu text, dob integer, gender text)")
