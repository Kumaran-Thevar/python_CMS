...
class Window_1:
    def __init__(self, master):
        ...
        self.Frame = Frame(self.master, bg='#D8E3E7')
        self.Frame.pack()
        ...
        self.Lbl_Title = Label(self.Frame, text = 'Login Menu', font = ('arial',55,'bold'), bg = '#D8E3E7', fg = '#191970')
        ...
        #===================================================LABEL and ENTRIES=======================================================================
        self.Label_Username = Label(self.Login_Frame_1, text = 'Username', font = ('arial',20,'bold'), bg = '#D8E3E7',fg='#191970', bd = 20)
        ...
        self.Label_Password = Label(self.Login_Frame_1, text = 'Password', font = ('arial',20,'bold'), bg = '#D8E3E7',fg='#191970', bd = 20)
