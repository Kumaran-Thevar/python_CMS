...
class Fee():
    def __init__(self, master):
        ...
        Title_Frame = LabelFrame(
            Main_Frame, width=1350, height=100, bg='#D8E3E7', relief='flat', bd=15)
