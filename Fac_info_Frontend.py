               ...
               #==========================================================Functions====================================================================
                     def FacultyRec(event):
                            try: 
                                   ...
                                   self.Entry_emailID.insert(END, selected_tuple[2])

                                   self.Entry_address.delete(0, END)
                                   self.Entry_address.insert(END, selected_tuple[3])

                                   self.Entry_mobno.delete(0, END)
                                   self.Entry_mobno.insert(END, selected_tuple[4])

                                   self.Entry_edu.delete(0, END)
                                   self.Entry_edu.insert(END, selected_tuple[5])

                                   self.Entry_dob.delete(0, END)
                                   self.Entry_dob.insert(END, selected_tuple[6])

                                   self.Entry_gender.delete(0, END)
                                   self.Entry_gender.insert(END, selected_tuple[7])
                            except IndexError:
                                   pass
                     ...
                     self.Label_emailID.grid(row = 1, column = 0, sticky = W, padx = 20)
                     ...
                     self.Label_mobno.grid(row = 3, column = 0, sticky = W, padx = 20)

                     self.Label_edu = Label(self.Frame_1, text = 'Education', font = ('arial',20,'bold'),  bg = '#D8E3E7', fg='#191970')
                     self.Label_edu.grid(row = 4, column = 0, sticky = W, padx = 20)
                     
                     self.Label_dob = Label(self.Frame_1, text = 'Date of Birth', font = ('arial',20,'bold'),  bg = '#D8E3E7', fg='#191970')
                     self.Label_dob.grid(row = 5, column = 0, sticky = W, padx = 20)

                     self.Label_gender = Label(self.Frame_1, text = 'Gender', font = ('arial',20,'bold'),  bg = '#D8E3E7', fg='#191970')
                     self.Label_gender.grid(row = 6, column = 0, sticky = W, padx = 20, pady = 10)
                     ...
                     self.Entry_emailID.grid(row = 1, column = 1, padx = 10, pady = 5)
                     ...
                     self.Entry_gender.grid(row = 6, column = 1, padx = 10, pady = 5)
